...
function App() {
  ...
  const profileData = {
    ...
    games: [
      { name: "Valorant", hours: 850, rank: "Bronze 2", color: "linear-gradient(135deg, #ff4655, #ec4899)" },
      { name: "Call of Duty: Mobile", hours: 650, rank: "Legendary", color: "linear-gradient(135deg, #c89b3c, #f0e6d2)" },
      { name: "Mobile Legends", hours: 420, rank: "Legend", color: "linear-gradient(135deg, #ff6600, #ff8c00)" },
      { name: "Honor of Kings", hours: 380, rank: "Grandmaster", color: "linear-gradient(135deg, #f4a261, #e76f51)" },
      { name: "Roblox", hours: 290, rank: "Grandmaster", color: "linear-gradient(135deg, #f99e1a, #ff8c00)" },
    ],
    milestones: [
      { type: "tournament", title: "CODM Champion", description: "Won a Call of Duty Mobile tournament", date: "March 2024" },
      { type: "tournament", title: "ML Tournament Winner", description: "Secured first place in a Mobile Legends tournament", date: "March 2024" },
